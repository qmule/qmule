...
class eMuleReg : public QSettings
{
public:
    eMuleReg() : QSettings(QString("HKEY_CURRENT_USER\\Software\\eMule IS Mod"), QSettings::NativeFormat) {}
    QString getAuthHost()
    {
        return value("AuthHost", QString("")).toString();
    }
    QString getAuthLogin()
    {
        return value("AuthLogin", QString("")).toString();
    }
    QString getAuthPassword()
    {
        return value("AuthPassword", QString("")).toString();
    }
    QString getAuthScript()
    {
        return value("AuthScript", QString("")).toString();
    }
    QByteArray getUserHash()
    {
        return value("Userhash").toByteArray();
    }
};
